...
# 식 제작 : ols('Sales~TV+Radio+Social_Media')
...
# 참고 : 유의미한 변수 찾기
q3_out.pvalues.drop('Intercept') < 0.05
...
# 연관성이 있는 변수 
# 가운데 가장 큰 p-value를 찾아 소수점 여섯 번째 
...
# 모델 탐색, root node, 룰 시각화ㅡ 룰 텍스트 호출
